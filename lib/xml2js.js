    ...
    Parser.prototype.reset = function() {
      ...
      this.saxParser.onopentag = (function(_this) {
        return function(node) {
          var i, key, newValue, obj, processedKey, uri, ref, _i, _ref1;
          obj = {};
          obj[charkey] = "";
          ...
          if (_this.options.xmlns) {
            uri = node.uri;
            for (i = _i = _ref1 = stack.length - 1; _ref1 <= 0 ? _i <= 0 : _i >= 0; i = _ref1 <= 0 ? ++_i : --_i) {
              if (uri) {
                break;
              }
              uri = stack[i][_this.options.xmlnskey].uri;
            }
      ...
      this.saxParser.onclosetag = (function(_this) {
        return function() {
          ...
          if (_this.options.validator != null) {
            ...
            try {
              obj = _this.options.validator(xpath, s && s[nodeName], obj, stack);
            } catch (_error) {
              err = _error;
              obj = _this.options.validator(xpath, s && s[nodeName], obj, stack);
            } catch (error1) {
